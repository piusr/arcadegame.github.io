...
var Enemy = function(x, y, speed) { //We pass the x,y parameters to each bug its own initial x,y position
    // Variables applied to each of our instances go here,
    // we've provided one for you to get started
     this.x = x;
     this.y = y + 55; //centers the enemy on the y axis
     this.speed = speed;
     this.step = 101;
...
class Hero {
   ...
   if (this.y === 55) {//check to see if heros y equals to the top of the grid(0)
    this.victory = true;
...
const bug3 = new Enemy((-101*2.5), 150, 250);
const bug4 = new Enemy((-101*3), 50, 300);
const bug5 = new Enemy((-101*3.5), 93, 300);
const bug6 = new Enemy((-101*4), 180, 150);
